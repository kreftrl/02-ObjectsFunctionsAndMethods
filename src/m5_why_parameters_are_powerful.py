...
def main():
    ...
    #even_better_draw_circles(rg.Point(100,50),15, 5, 'red', 5)
    #even_better_draw_circles(rg.Point(-200,0),3, 10, 'blue', 1)

    even_better_draw_circles(rg.Point(-390,-320),30,40,'purple',5)
    even_better_draw_circles(rg.Point(-390+5*1,-320+5*1), 30, 40, 'blue', 5)
    even_better_draw_circles(rg.Point(-390+5*2,-320+5*2), 30, 40, 'green', 5)
    even_better_draw_circles(rg.Point(-390+5*3,-320+5*3), 30, 40, 'yellow', 5)
    even_better_draw_circles(rg.Point(-390+5*4,-320+5*4), 30, 40, 'orange', 5)
    even_better_draw_circles(rg.Point(-390+5*5,-320+5*5), 30, 40, 'red', 5)
...
def better_draw_circles(point,changeradius):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN 15 pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(changeradius)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(changeradius * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point,changeradius,numberdrawn,color,thickness):
    ...
    for k in range(1, numberdrawn+1):  # k becomes 1, 2, 3, ... 10
